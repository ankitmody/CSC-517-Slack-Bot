...
describe('Slack Test', () => {
    ...
    it('Should be able to construct an example for create repo', async() => {
      ...
      expect(messages.pop()).toBe(requestReply)

      await page.waitFor(2000);
  });
    it('Should be able to construct an example for search topics', async() => {
    ...
    it('Should be able to construct an example for edit an issue topics', async() => {
        // example for search topics
    ...
    it('Should be able to construct an example for getting info about an user', async() => {
